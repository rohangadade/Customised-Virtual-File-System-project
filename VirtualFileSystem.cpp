...
void man(char *name)
{
    ...
    {
        printf("Description : Used to erite into regular file\n");
        printf("Usage : erite File_name\n After this enter the data that we want to write\n");
    }
...
void DisplayHelp()
{
    ...
    printf("closeall : To close all append files \n");
...
void InitialiseSuperBlock()
{
    ...
    while(i < MAXINODE)
    {
        UFDTArr[i].ptrfiletable = NULL; //sagale pointer null kele
        i++;
    }
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                system("cls");  //system function program through os la command deta
                continue;
            }
        ...
        else if(count == 2)     //jar command madhe 2 word satil tr
        {
            ...
            else if(strcmp(command[0],"rm") == 0)
            {
                ...
                if(ret == -1)
                    printf("EROOR : There is no such file\n");
                continue;
            }
        ...
        else if(count == 3) //jar command madhe 3 word astil tr
        {
            if(strcmp(command[0],"create") == 0)
            {
                ret = CreateFile(command[1],atoi(command[2])); //(atoi = ascii to integer convert function) //He kasa work zal nai kalal pn zal
                if(ret >= 0)
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                        printf("File is succesfully opened with file descriptor : %d",ret);
                if(ret == -1)
                        printf("ERROR : Incorrect parameters\n");
                if(ret == -2)
